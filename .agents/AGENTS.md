...
| **Senior Information Security Engineer** | [roles/senior-infosec-engineer.base.md](roles/senior-infosec-engineer.base.md) | Information security, infosec, cloud security, infrastructure security, DevSecOps, Zero Trust, NIST CSF, MITRE ATT&CK, incident response, SIEM, GRC, compliance, SOC 2, ISO 27001, risk assessment, security architecture, IAM, container security, AI/ML security, security operations |
