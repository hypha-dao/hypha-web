...
| **Senior MCP Engineer** | [roles/senior-mcp-engineer.base.md](roles/senior-mcp-engineer.base.md) | MCP server architecture, tool schema contracts, transport integration, MCP hardening, Cursor MCP implementation, incremental MCP migrations |
