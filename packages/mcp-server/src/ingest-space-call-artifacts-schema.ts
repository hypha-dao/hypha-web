...
export const ingestSpaceCallArtifactsInputSchema = z
  .object({
  ...
  .refine((data) => Boolean(data.recording || data.transcript), {
    message: 'At least one of recording or transcript is required',
  });
