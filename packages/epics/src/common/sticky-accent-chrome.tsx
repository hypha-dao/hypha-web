...
} from '../spaces/components/compact-space-banner';
...
export type StickyAccentChromeProps = {
...
/**
 * Desktop (md+): compact row under MenuTop when scrolled; mirrors CompactSpaceBanner horizontal grid.
 * Portaled to document.body so SidebarInset overflow does not clip fixed positioning.
 */
export function StickyAccentChrome({
  banner,
  actionsSlot,
  title,
  logoUrl,
