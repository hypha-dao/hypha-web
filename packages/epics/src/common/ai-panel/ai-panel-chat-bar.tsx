...
export function AiPanelChatBar({
  ...
  const heroSendButtonClass =
    'flex h-9 w-9 shrink-0 items-center justify-center rounded-chrome border-0 bg-accent-9 p-0 text-accent-contrast transition-colors hover:bg-accent-10 disabled:cursor-not-allowed disabled:opacity-50';
