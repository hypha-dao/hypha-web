...
import { Phone, Video, Volume2, VolumeX, X } from 'lucide-react';
        ...
        <div className="flex min-w-0 shrink-0 items-center gap-2 sm:gap-2.5">
          ...
          <button
            ...
            className={cn(
              ...
              (disabled || hasDurable) && 'cursor-not-allowed opacity-50',
            )}
            title={
              callAlertsUnmuted
          ...
          >
            <button
              type="button"
              onClick={onJoinAudio}
              disabled={disabled || busy || hasDurable}
              className={cn(
                ...
                (disabled || busy || hasDurable) &&
                  'cursor-not-allowed opacity-50',
                !disabled && !busy && !hasDurable && 'hover:bg-muted',
              )}
