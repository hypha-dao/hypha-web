        ...
        {selectionBar && (
          <>
            ...
            <div
              ...
              className="absolute z-30 flex -translate-x-1/2 -translate-y-full items-center gap-0.5 rounded-lg border border-border bg-popover px-1 py-1 text-popover-foreground shadow-lg"
              style={{
                left: selectionBar.left,
