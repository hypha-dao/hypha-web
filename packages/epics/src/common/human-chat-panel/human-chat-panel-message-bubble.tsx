...
import {
  ...
  renderTextWithMentionsFromSegments,
} from './parse-chat-mentions';
...
type HumanChatPanelMessageBubbleProps = {
  ...
  message: {
    ...
    /** Matrix msgtype for media messages */
    msgType?: string;
    /** Resolved HTTP URL for MXC media */
    mediaHttpUrl?: string;
    /** Original filename for m.file when body is caption */
