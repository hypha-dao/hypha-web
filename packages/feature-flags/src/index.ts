 ...
 * then **`NEXT_PUBLIC_*` env** (`"true"` enables, `"false"` disables; **when unset, features default
 * to on**). Human Chat: kill-switch `HYPHA_DISABLE_HUMAN_CHAT` / `NEXT_PUBLIC_DISABLE_HUMAN_CHAT` still
 * forces off.
 *
