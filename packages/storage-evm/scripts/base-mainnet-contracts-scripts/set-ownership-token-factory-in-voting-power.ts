...
interface OwnershipTokenVotingPowerInterface {
  setOwnershipTokenFactory(tokenFactory: string): Promise<any>;
...
async function main(): Promise<void> {
  ...
  // Get the OwnershipTokenVotingPower contract instance
  ...
  try {
    ...
    const contractOwner = await ownershipTokenVotingPower.owner();
    ...
    // Set the ownership token factory
    console.log('\nSetting ownership token factory...');
    const tx = await ownershipTokenVotingPower.setOwnershipTokenFactory(
    ...
    console.log('\n✅ Successfully set ownership token factory!');
    console.log(
      `OwnershipTokenVotingPower (${ownershipTokenVotingPowerAddress}) now recognizes`,
    );
    console.log(
      `OwnershipTokenFactory (${ownershipTokenFactoryAddress}) as the authorized factory.`,
    );
  } catch (error) {
    console.error('Error setting ownership token factory:', error);
...
function displayUsage() {
  console.log(
    'This script sets the ownership token factory address in the OwnershipTokenVotingPower contract.',
  );
  console.log('');
  ...
  console.log('');
  console.log('Usage:');
  console.log('  ts-node set-ownership-token-factory-in-voting-power.ts');
}
