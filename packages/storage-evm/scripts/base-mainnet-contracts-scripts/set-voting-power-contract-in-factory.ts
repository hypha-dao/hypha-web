...
async function main(): Promise<void> {
  ...
  try {
    ...
    const tx = await regularTokenFactory.setVotingPowerContract(
    ...
    console.log(
      `RegularTokenFactory (${regularTokenFactoryAddress}) now recognizes`,
    );
    console.log(
      `TokenVotingPower (${tokenVotingPowerAddress}) as the voting power contract.`,
    );
    console.log(
      '\nThis allows the factory to register tokens as voting tokens automatically.',
    );
  } catch (error) {
...
function displayUsage() {
  console.log(
    'This script sets the voting power contract address in the RegularTokenFactory contract.',
  );
  console.log('');
  console.log(
    'This enables the RegularTokenFactory to automatically register tokens as voting tokens',
  );
  console.log('when deployToken() is called with isVotingToken=true.');
  console.log('');
  ...
  console.log('');
  console.log('Usage:');
  console.log('  ts-node set-voting-power-contract-in-factory.ts');
}
