...
export const decayingSpaceTokenAbi = [
  ...
  },
  {
    ...
    name: 'CreditWhitelistAddressUpdated',
  },
  {
    type: 'event',
    anonymous: false,
  ...
  },
  {
    ...
    name: 'batchSetAuthorizedMinters',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        name: '_initialAuthorizedMinters',
        internalType: 'address[]',
        type: 'address[]',
      },
    ],
...
export const decayingTokenFactoryAbi = [
  ...
  },
  {
    ...
    inputs: [
      {
        name: 'p',
        internalType: 'struct DecayingTokenFactory.DeployParams',
        type: 'tuple',
        components: [
          { name: 'spaceId', internalType: 'uint256', type: 'uint256' },
          { name: 'name', internalType: 'string', type: 'string' },
    ...
    name: 'deployDecayingTokenWithMinters',
    outputs: [{ name: '', internalType: 'address', type: 'address' }],
    stateMutability: 'nonpayable',
  },
  {
...
export const ownershipTokenFactoryAbi = [
  ...
  },
  {
    ...
    inputs: [
      {
        name: 'p',
        internalType: 'struct OwnershipTokenFactory.DeployParams',
        type: 'tuple',
        components: [
          { name: 'spaceId', internalType: 'uint256', type: 'uint256' },
          { name: 'name', internalType: 'string', type: 'string' },
    ...
    name: 'deployOwnershipTokenWithMinters',
    outputs: [{ name: '', internalType: 'address', type: 'address' }],
    stateMutability: 'nonpayable',
  },
  {
...
export const regularTokenFactoryAbi = [
  ...
  },
  {
    ...
    inputs: [
      {
        name: 'p',
        internalType: 'struct RegularTokenFactory.DeployParams',
        type: 'tuple',
        components: [
          { name: 'spaceId', internalType: 'uint256', type: 'uint256' },
          { name: 'name', internalType: 'string', type: 'string' },
 ...
 */
export const transferHelperAbi = [
  { type: 'constructor', inputs: [], stateMutability: 'nonpayable' },
  {
    type: 'error',
    inputs: [{ name: 'owner', internalType: 'address', type: 'address' }],
  ...
  },
  {
    ...
    name: 'WhitelistRequirementChanged',
  },
  {
    type: 'function',
    inputs: [{ name: 'token', internalType: 'address', type: 'address' }],
