...
// function changeSpaceTransparencySettingsTx(
//   spaceId: number,
...
//       functionName: 'changeSpaceTransparencySettings',
//       args: [
//         BigInt(spaceId),
//         BigInt(spaceDiscoverability),
//         BigInt(spaceActivityAccess),
//       ],
//     }),
//   };
// }
...
export const useChangeSpaceTransparencySettingsMutationsWeb3Rpc = ({
  ...
  //       changeSpaceTransparencySettingsTx(
  //         arg.spaceId,
  //         arg.spaceDiscoverability,
  //         arg.spaceActivityAccess,
  //       ),
  //     ];
