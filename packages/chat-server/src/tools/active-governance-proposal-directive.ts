...
export function buildActiveGovernanceProposalDirective(
  ...
  return [
    ...
    `Voice/Live Voice: ${VOICE_SPOKEN_SENTENCE_LIMIT} short sentences per turn. Typed chat: max 3–4.`,
    'When opening or updating the form: call prepare_governance_proposal FIRST in the same turn — never announce "opening the form" or "one moment" in chat before the tool runs.',
