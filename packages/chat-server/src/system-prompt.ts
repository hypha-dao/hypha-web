...
- create_space_setup_proposal: create a setup proposal for a space (Web2 document + on-chain vote). Use only after showing title/description intent and obtaining explicit confirmation; after confirmation the user must sign a wallet transaction before the proposal appears under Agreements.
