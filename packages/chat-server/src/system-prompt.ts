...
- For requests to move from one space to another inside the same ecosystem, call mcp_navigation with destination_type "ecosystem_space" and the target name/description so navigation resolves in one step.
