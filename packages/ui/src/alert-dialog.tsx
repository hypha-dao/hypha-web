  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        viewport === 'full'
          ? 'left-1/2 top-[calc((100dvh+var(--menu-top-height,70px))/2)] w-[min(32rem,calc(100vw-2rem))]'
          : 'left-[calc((var(--sidebar-left-width,0px)+100vw-var(--sidebar-right-width,0px))/2)] top-[calc((100dvh+var(--menu-top-height,70px))/2)] w-[min(32rem,calc(100vw-var(--sidebar-left-width,0px)-var(--sidebar-right-width,0px)-2rem))]',
        className,
      )}
      {...props}
    />
