...
test.describe('Coherence Chat Panel Integration', () => {
  ...
  test.describe('Signal Card → Panel Interaction (authenticated)', () => {
    test.fixme('clicking a signal card opens the right panel', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
    ...
    test.fixme('clicking a signal card does NOT navigate away from coherence page', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
    ...
    test.fixme('"Open conversation" button on signal card opens the panel in coherence mode', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
    ...
    test.fixme('signal card is rendered as a button (not a link) when onSignalClick is wired', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
  ...
  test.describe('Panel in Coherence Mode (authenticated)', () => {
    test.fixme('panel header shows the signal conversation title in coherence mode', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
    ...
    test.fixme('panel header shows ArrowLeft back button in coherence mode', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
    ...
    test.fixme('panel header does not show default "Chat" title in coherence mode', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
    ...
    test.fixme('panel messages area is visible in coherence mode', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
    ...
    test.fixme('send button is disabled when chat input is empty in coherence mode', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
    ...
    test.fixme('send button is enabled after typing in chat input in coherence mode', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
    ...
    test.fixme('chat input does not clear when send button is clicked without auth (no roomId)', async ({
      page,
    }) => {
    ...
    test.fixme('panel shows loading state while joining coherence room', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
  ...
  test.describe('Back Navigation and Panel Close (authenticated)', () => {
    test.fixme('clicking back button returns panel to space chat mode', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
    ...
    test.fixme('closing panel via close button resets to space chat mode on re-open', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
    ...
    test.fixme('clicking a different signal replaces the previous coherence room in the panel', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
    ...
    test.fixme('panel remains open after clicking back (does not close)', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
  ...
  test.describe('Space Chat Preservation (authenticated)', () => {
    test.fixme('space chat mode is the default state of the panel on coherence page', async ({
      page,
    }) => {
      const chatPanel = new HumanChatPanelPage(page);
      await page.goto(`/en/dho/${SPACE_SLUG}/coherence`);
    ...
    test.fixme('navigating to coherence from another route preserves space chat mode', async ({
      page,
    }) => {
      const chatPanel = new HumanChatPanelPage(page);
    ...
    test.fixme('closing coherence mode and reopening panel shows space chat (welcome message)', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
  ...
  test.describe('Edge Cases (authenticated)', () => {
    test.fixme('signal without roomId has disabled "Open conversation" button', async ({
      page,
    }) => {
    ...
    test.fixme('archived signal card does not have a button wrapper (no panel open)', async ({
      page,
    }) => {
    ...
    test.fixme('panel stays in coherence mode when scrolling the coherence page', async ({
      page,
    }) => {
      const chatPanel = new CoherenceChatPanelPage(page, SPACE_SLUG);
      await chatPanel.openCoherencePage();
